...
fn initialise_app() -> (impl AsRef<Path>, Option<impl AsRef<Path>>) {
    let model_path = "/Users/aidenlee/DeepSpeechClient/deepspeech-0.9.3-models.pbmm";
    let scorer_path = "/Users/aidenlee/DeepSpeechClient/deepspeech-0.9.3-models.scorer";
